...
class TestOptionsViewZoneServer(unittest.TestCase):
    ...
    def test_isc_optviewzoneserver_stmt_also_notify_passing(self):
        ...
        test_string = [
            'also-notify { mains; };',
            'also-notify { mains key lockbox0_key; };',
            'also-notify { mains port 54; };',
            'also-notify { mains port 54 key lockbox1_key; };',
            'also-notify { mains port 55 dscp 3; };',
            'also-notify { mains port 55 dscp 3 key lockbox2_key; };',
            'also-notify { mains dscp 3; };',
            'also-notify { mains dscp 3 key lockbox3_key; };',
            'also-notify { 1.1.1.1; };',
    ...
    def test_isc_optviewzoneserver_statements_set_passing(self):
        ...
        test_string = [
            ...
            'also-notify { 1.1.1.1 port 58 dscp 4 key lockbox6_key; fe01::1 dscp 6 key lockbox11_key; };',
            'also-notify { mains; };',
            'also-notify { mains key DDNS_UPDATER; };',
            'also-notify { 1.1.1.1; };',
